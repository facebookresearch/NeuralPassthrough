...
# ACKNOWLEDGEMENT
# The code within this file was taken and revised accordingly from the following repo:
# https://github.com/sniklaus/softmax-splatting/blob/master/softsplat.py
# Please refer to the above repo for license requirement for using the softmax-splatting code. 
